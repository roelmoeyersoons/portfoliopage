            ...
            <motion.div key={active.id} variants={paneV} initial="hidden" animate="show" exit="exit">
              <BentoGrid glowColor={GLOW.orange} className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <motion.div variants={cardV} className="min-w-0 sm:col-span-2 lg:row-span-2">
                  <BentoCard glowColor={GLOW.orange} className="h-full px-5 py-5">
                    <p className="text-[11px] font-semibold uppercase tracking-[0.24em] text-pink-300/90">The story</p>
                    <h3 className="mt-2 font-display text-2xl font-bold tracking-tight text-white">{active.role}</h3>
                ...
                <motion.div variants={cardV} className="min-w-0">
                  <BentoCard glowColor={GLOW.pink} className="h-full p-0">
                    <div className="relative h-44 min-h-[176px] sm:h-full sm:min-h-[190px]">
                      ...
                      <div className="absolute bottom-4 left-4 right-4 flex flex-wrap gap-1.5">
                        <Chip className="!border-orange-400/25 !bg-orange-500/10 !px-2 !py-0.5 !text-[9.5px] text-orange-200">
                          {active.type}
                        </Chip>
                ...
                {/* metrics — row 2, col 4 */}
                <motion.div variants={cardV} className="min-w-0">
                  <BentoCard glowColor={GLOW.pink} className="h-full justify-center gap-3 px-4 py-5">
                ...
                <motion.div variants={cardV} className="min-w-0 sm:col-span-2 lg:col-span-1">
                  <BentoCard glowColor={GLOW.orange} className="h-full justify-between px-4 py-5">
                ...
                {hasSkills && (
                  <motion.div variants={cardV} className="min-w-0 sm:col-span-2 lg:col-span-3">
                    <BentoCard glowColor={GLOW.pink} className="h-full px-5 py-5">
                      <h4 className="mb-3 flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.22em] text-white/60">
                        <Zap size={12} className="text-pink-300" /> Skills demonstrated
                      </h4>
                        ...
                        {active.skillIds
                          ...
                          .map((skill) => (
                            <button
                              ...
                              className="rounded-full border border-pink-400/25 bg-pink-500/10 px-3 py-1.5 text-[11.5px] font-medium text-pink-200 transition-colors hover:border-pink-400/50 hover:bg-pink-500/20"
                            >
                              {skill.title}
                            </button>
                          ))}

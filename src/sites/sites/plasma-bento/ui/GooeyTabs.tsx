/**
 * Plasma Bento — GooeyTabs.
 *
 * Local fork of the ReactBits `GooeyNav` (which has internal state and no
 * selection callback). Changes:
 ...
 *   - re-coloured to the orange/pink/violet plasma palette.
 *
...
const GooeyTabs: React.FC<GooeyTabsProps> = ({
  ...
  return (
    <div className="pb-gooey-surface">
      <div className="pb-gooey-scroll">
        <div className={cn('pb-gooey', className)} ref={containerRef}>
          <nav>
